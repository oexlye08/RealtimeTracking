package id.web.realtimetracking.Model;

public class MyLocation {
    private int accuracy,altitude,bearing,bearingAccuracyDegress,speed,
    ...
    public int getBearingAccuracyDegress() {
        return bearingAccuracyDegress;
    }

    public void setBearingAccuracyDegress(int bearingAccuracyDegress) {
        this.bearingAccuracyDegress = bearingAccuracyDegress;
    }
